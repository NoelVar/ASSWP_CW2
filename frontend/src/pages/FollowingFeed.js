...
const FollowingFeed = () => {
    ...
    const handleMostComments = (e) => {
        ...
        if (posts) {
            ...
            setPosts(mostCommented)
            setCurrentPage(1)
        }
    }

    // PAGINATION HANDLERS ------------------------------------------------------------------------
    // GET CURRENT PAGES POSTS
                ...
                <form onSubmit={handleFilter}>
                    ...
                    <div className='single-filter'>
                        ...
                        <select required onChange={e => setSelectedCountry(e.target.value)}>
                            <option disabled defaultValue={null} selected hidden value={null}>Select a country</option>
                    ...
                    <div className='single-filter'>
                        <h3>Feeds</h3>
                        <Link to='/posts'>General Feed</Link>
                        <Link to='/following-feed' className='active'>Following Feed</Link>
                    </div>
                </form>
            </div>
            <div className='post-page'>
                <h1 className='title'>Following Feed</h1>
